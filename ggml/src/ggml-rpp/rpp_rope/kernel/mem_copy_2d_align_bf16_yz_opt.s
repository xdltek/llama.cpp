...
LDPARAM.U32 [inBZStride], %inBZStride
LDPARAM.U32 [outBZStride], %outBZStride
...
MUL.U16.WIDE %blockIdx.z, %one, %bidZ32
MUL.U32.LOW %bidZ32, %inBZStride, %tmp0
...
##
MUL.U32.LOW %bidZ32, %outBZStride, %tmp0
