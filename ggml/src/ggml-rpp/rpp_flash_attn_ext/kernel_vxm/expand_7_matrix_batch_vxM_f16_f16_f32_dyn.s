...
LDPARAM.U16 [rollback1], %rollback1
...
LOADALN.Z32 %input1Tmp, %sreg0, %Tmp0, MB
MOVE.U16 MB, VA
##
COPYEXT VA, IF
LOAD [DVA], MA
...
COPY VAB, IAB
MOVE.U16 2, %sreg0
SHL.U16 %expandStride, %sreg0, %sreg0
CVT.U16.U32 %sreg0, DS13
ADD.U32 %input0, DS13, DS13
MMOV DS13, DVA
SUB.S32 %input1, %offset0, %input1Tmp
...
COPY VAB, ICD
LOAD [DVA], MA
MSUB DVA, %rollback1, DVA
HFMA MA, IF, IGH, VAB
##

SUB.U16 %channel, %one, %channel
JMPC %channel, $BLOCK_ENTRY_2
LDPARAM.U16 [channel], %channel
COPYEXT VAB, IGH
ADD.U32 %out, %outBatchStride, %out
STOREALN %out, %sreg1, %sreg1, IB
...
##
ADD.U32 %out, %outBatchStride, %out
STOREALN %out, %sreg1, %sreg1, IH
##
MOVE.U32 0, VAB
ADD.U32 %outLow, %outBatchStride, %outLow
STOREALN %outLow, %sreg1, %sreg1, IG
##
