...
LOADALN.Z32 %in_wq_msb, %inStrideY, %inStrideZ, MB
COPYEXT MB, IH
SHL.U16 MB, 4, VA
##
AND.U16 VA, 0x10, VA
...
LDPARAM.U32 [inBlockXSize1], %blockSize0
ADD.U32 %in_wq_msb, %blockSize0, %in_wq_msb
...
ADD.U32 %in_wq, %blockSize0, %in_wq
LDPARAM.U32 [inBlockYSize1], %blockSize0
ADD.U32 %in_wq_msb, %blockSize0, %in_wq_msb
