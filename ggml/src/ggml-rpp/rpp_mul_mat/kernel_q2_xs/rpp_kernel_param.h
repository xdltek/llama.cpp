...
static void q2xs_dequant_params(dim3 &                  blocksPerGrid,
                                dim3 &                  threadsPerBlock,
                                uint32_t                in_wq,
                                uint32_t                scale,
                                uint32_t                output,
    ...
    int dequantStrideZ    = 16 * dequantStrideY;
