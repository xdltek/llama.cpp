...
static void q3xxs_dequant_params(dim3 &                  blocksPerGrid,
                                 dim3 &                  threadsPerBlock,
                                 uint32_t                in_wq,
                                 uint32_t                in_sign,
                                 uint32_t                scale,
    ...
    inBlockXSize0 -= (2 * 2) * in_unroll_stride;
    ...
    //----------------------------------------------------------------------------------------------------
    // out_addr   [N/32]   | [K/256]      | [8] | [2]     | [16]        | [32]
    // out_addr            | [z]          | [y] | [loop]  | [unroll1]   | [x]
    //            [grid.x] | [grid.y]*[z] | [y]                         | [x]
    //-----------------------------------------------------------------------------------------------------
