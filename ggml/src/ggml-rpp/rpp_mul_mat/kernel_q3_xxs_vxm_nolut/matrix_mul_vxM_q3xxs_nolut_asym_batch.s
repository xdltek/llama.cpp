...
.param   .U32 in_wq_stridez
.param   .U32 in_sign_stridez
.param   .U32 in_scale_stridez
.param   .U32 in_a_stridez
...
DECTID.Z MB, %Tmp1, VA
##
LDPARAM.U16 [in_a_stridez], S26
MUL.U16.WIDE VA, S26, VAB
##
MMOV VAB, DVA
##
...
//----------------------------------------------------------------------------------------------------
$UNROLL_0:
LDPARAM.U32 [in_sign_stridez], DS13
LOADALN.Z32 %in_sign, %one, DS13, IB
##
LDPARAM.U32 [in_wq_stridez], DS13
LOADALN.Z32 %in_wq, %one, DS13, MB
COPYEXT MB, IG
AND.U16 MB, 0x7, VA
##
...
//acc(a * wq) = IEF
//----------------------------------------------------------------------------------------
LDPARAM.U32 [in_scale_stridez], DS13
LOADALN.Z32 %in_scale, %one, DS13, MB
CVT.F16.F32 MB, VAB
##
MUL.F32 VAB, IEF, VAB
##
